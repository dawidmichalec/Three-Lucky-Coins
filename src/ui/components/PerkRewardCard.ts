...
export class PerkRewardCard extends Container {
    ...
    private createDescription(): void {
        ...
        const description =
            new LocalizedText(
                this.reward.variant.description,
                {
                    font: "Open Sans",
                    fontWeight: "bold",
                    fontSize: 28,
        ...
        mask.position.copyFrom(
            descriptionContainer.position
        );


        descriptionContainer.mask =
            mask;


        descriptionContainer.eventMode =
            "static";
