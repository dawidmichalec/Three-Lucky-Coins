...
export class DealerDetailContent extends Container {
    ...
    private createScrollableContent() {
        ...
        this.scrollContent.position.set(
            0,
            0
        );
        ...
        const description = new LocalizedText(
            this.dealer.dealerDescription,
            {
                font: "Open Sans",
                fontSize: 24,
                fill: 0xffffff,
        ...
        if (this.dealer.skills.length === 0) {
            ...
            const noSkills = new LocalizedText(
                "noSkills",
                {
                    font: "Open Sans",
                    fontSize: 24,
            ...
            for (const skill of this.dealer.skills) {
                ...
                const skillName = new LocalizedText(
                    skill.name,
                    {
                        font: "Open Sans",
                        fontSize: 24,
