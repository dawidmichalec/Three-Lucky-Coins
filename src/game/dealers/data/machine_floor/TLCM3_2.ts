...
import { TLCM3_2_PROFILE } from "../../../probability/DealerOddsProfiles.ts";

export const TLCM3_2_DATA: DealerData = {
  id: "tlcm-3_2",
  ...
  skills: [
      {
          id: DealerSkillId.BET_SLOT_MALFUNCTION,
          name: "betSlotMalfunctionSkillName",
          description: "betSlotMalfunctionSkillDescription",
          icon: "/assets/main/icons/dealer_skill_icons/machine_floor/tlcm-3_2/bet_slot_malfunction.png",
      },
    ],
