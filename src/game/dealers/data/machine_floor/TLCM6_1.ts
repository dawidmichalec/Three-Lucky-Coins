...
import { TLCM6_1_PROFILE } from "../../../probability/DealerOddsProfiles.ts";

export const TLCM6_1_DATA: DealerData = {
  id: "tlcm-6_1",
  ...
  skills: [
      {
          id: DealerSkillId.UNSTABLE_PROBABILITY_DISPLAY,
          name: "unstableProbabilityDisplaySkillName",
          description: "unstableProbabilityDisplaySkillDescription",
          icon: "/assets/main/icons/dealer_skill_icons/machine_floor/tlcm-6_1/unstable_probability_display.png",
      },
    ],
