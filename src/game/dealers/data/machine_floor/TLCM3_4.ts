...
import { TLCM3_4_PROFILE } from "../../../probability/DealerOddsProfiles.ts";

export const TLCM3_4_DATA: DealerData = {
  id: "tlcm-3_4",
  ...
  skills: [
      {
          ...
          name: "betDepletionSkillName",
          description: "betDepletionSkillDescription",
          icon: "/assets/main/icons/dealer_skill_icons/machine_floor/tlcm-3_4/bet_depletion.png",
      },
    ],
