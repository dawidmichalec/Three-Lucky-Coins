...
import { TLCM7_1_PROFILE } from "../../../probability/DealerOddsProfiles.ts";

export const TLCM7_1_DATA: DealerData = {
  id: "tlcm-7_1",
  ...
  skills: [
      {
          id: DealerSkillId.RANDOM_COMBINATION_BLOCK,
          name: "randomCombinationBlockSkillName",
          description: "randomCombinationBlockSkillDescription",
          icon: "/assets/main/icons/dealer_skill_icons/machine_floor/tlcm-7_1/random_combination_block.png",
      },
    ],
