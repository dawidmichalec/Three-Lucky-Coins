...
export class RunPerkManager {
    ...
    getPerk(
        perkId: string
    ): ActiveRunPerk | undefined {

        return this.activePerks.get(
            perkId
        );
    }
    ...
    getActivePerks():
    readonly ActiveRunPerk[] {

        return Array.from(
            this.activePerks.values()
        );
    }
    ...
    removePerk(
        ...
        return this.activePerks.delete(
            perkId
        );
    }
