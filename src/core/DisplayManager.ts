...
export class DisplayManager {
  ...
  static getInstance(stage?: Container) {
    if (!DisplayManager.instance) {
      ...
      DisplayManager.instance = new DisplayManager(stage);
    }
  ...
  private constructor(private stage: Container) {
    ...
    this.stage.addChild(this.brightnessOverlay);
  ...
  setBrightness(value: number) {
    this.brightnessOverlay.alpha = 1 - value;
  }
  ...
  setFullscreenListener(callback: (enabled: boolean) => void) {
